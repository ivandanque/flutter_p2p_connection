...
object Constants {
    ...
    // Wi-Fi Aware (Mesh) Channel Names
    const val WIFI_AWARE_METHOD_CHANNEL_NAME = "com.ugo.studio.plugins.flutter_p2p_connection/wifi_aware" 
    ...
    const val MIN_WIFI_AWARE_API_LEVEL = Build.VERSION_CODES.O       // API 26 for basic Wi-Fi Aware
    const val MIN_WIFI_AWARE_DATA_PATH_API_LEVEL = Build.VERSION_CODES.Q  // API 29 for data path
